...
- CORS origin not allowed:
	- Confirm CLIENT_ORIGIN includes your frontend URL.

- CSRF token is required:
	- Make sure the frontend calls /api/auth/me (handled by AuthContext on load) and sends credentials.

- Backend startup error about missing env vars:
	- Verify DATABASE_URL and JWT_SECRET in backend/.env.

- Production DATABASE_URL points to localhost:
	- Update DATABASE_URL to a public/managed database host.
