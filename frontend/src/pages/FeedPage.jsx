...
export default function FeedPage() {
  ...
  const handleCreatePost = async () => {
    ...
    if (!trimmedContent || isPosting) return;
                        ...
                        <div className="_feed_inner_text_area_bottom">
                          <div className="_feed_inner_text_area_item">
                            ...
                            <div className="_feed_inner_text_area_bottom_event _feed_common">
                              <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={() => setPostVisibility("private")}> 
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                            ...
                            <div className="_feed_inner_text_area_bottom_article _feed_common">
                              <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={() => setPostVisibility("public")}>
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                          ...
                          <div className="_feed_inner_text_area_btn">
                            <button type="button" className="_feed_inner_text_area_btn_link" onClick={handleCreatePost} disabled={isPosting}>
